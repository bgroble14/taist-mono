    <div class="footera clrgray0">
        <div class="flex flex_jspace">
            <div class="flex flex_acenter">
                <div class="fsize12 mr40"></div>
            </div>
        </div>
    </div>

    <link rel="stylesheet" href="{{ url('assets/css/mobile.css?r='.time()) }}">
    ...
    <script src="{{ url('assets/libs/js/qrcode.min.js') }}"></script>
