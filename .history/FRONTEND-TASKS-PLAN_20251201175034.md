...
1. **TMA-025** - Change "Special Requests" to "Special Instructions"
   - Just text replacements
   - 2-3 files
   - No logic changes

### 🟢 Level 2: Simple (< 2 hours)
2. **TMA-013** - Show Current Location on Home Tab
   - Add one display component
   - Data already available
   - Minimal styling

3. **TMA-019** - Order Receipt Customizations Display
   - Fix data display in one screen
   - Logic already exists, just not shown
   - Reference implementation available

4. **TMA-003** - Add Contact Us Text
   - Add text component
   - Simple styling
   - Just informational display

5. **TMA-021** - Calendar "Today" Button
...
8. **TMA-005** - Overall Styling Overhaul
   - Touches many files
